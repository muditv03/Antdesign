...
// const RelatedListEditDrawer = ({ visible, onClose, record, parentObjects, parentObjectName }) => {
...
//   useEffect(() => {
//     const fetchAllChildObjects = async () => {
//       const api = new apiService(`${BASE_URL}/child_objects`, {}, 'GET');
//       try {
//         const res = await api.makeCall();
//         setAllChildObjects(res);
//       } catch (error) {
//         message.error('Error fetching child objects');
//       }
//     };

//     fetchAllChildObjects();
//   }, []);
...
//     // Prepare the data object to match what the API expects
//     const data = {
//       related_list_name: relatedListName,
//       parent_object_name: parentObject,
//       child_object_name: selectedChild,
//       fields_to_display: fieldsToDisplay, // Directly using the array of field names
//     };

//     const api = new apiService(
//       `${BASE_URL}/related_lists/${record._id}/add_field`,
//       {},
//       'PUT',
//       data
//     );
...
//       })
//       .catch((error) => {
//         console.error("Error updating related list:", error); // Log the error for debugging
...
//         >
//           <Select placeholder="Select parent object">
...
//               onChange={value => form.setFieldsValue({ fieldsToDisplay: value })} // Update form on selection change
//             >
